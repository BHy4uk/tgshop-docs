...
<div class="landing-page">
	...
	<section class="landing-section" id="operations">
		...
		<div class="landing-timeline">
			...
			<article class="landing-step">
				<span>02</span>
				<strong>Оплата під ваш сценарій</strong>
				<p>Підтримуються Monobank Merchant, оплата за посиланням, реквізити та накладений платіж.</p>
			</article>
			<article class="landing-step">
				<span>03</span>
	...
	<section class="landing-section landing-feature-zone">
		<div class="landing-section-head split">
			...
			<p>
				...
				залежно від тарифу та увімкнених фіч, тому на лендингу немає порожніх обіцянок.
			</p>
		</div>
		<div class="landing-feature-grid">
			<article class="landing-feature-card">
				<span>Каталог</span>
				<strong>Товари, категорії, фото, варіанти, залишки</strong>
				<p>Редагування через бот або WebApp, до 5 фото на товар, tracked/untracked stock і керування активністю позицій.</p>
			</article>
			<article class="landing-feature-card">
			...
			<article class="landing-feature-card">
				<span>Платежі</span>
				<strong>Передплата і післяплата в одному контурі</strong>
				<p>Monobank, посилання, реквізити та накладений платіж керуються з інтерфейсу без змін у коді.</p>
			</article>
			<article class="landing-feature-card">
				<span>Операційка</span>
				<strong>Замовлення, статуси, перевірка оплат, доставка</strong>
				<p>Адмін працює з карткою замовлення, бачить фільтри, рух по статусах і виконує дії по оплаті та відправці.</p>
			</article>
			<article class="landing-feature-card">
				<span>Налаштування</span>
				<strong>Тексти, кнопки, вигляд, команда, підписка</strong>
				<p>Магазин можна адаптувати без розробника: від текстів checkout до керування доступами й білінгом.</p>
			</article>
			<article class="landing-feature-card">
				<span>Імпорт</span>
				<strong>Масове оновлення каталогу з файлу</strong>
				<p>Коли модуль активний, WebApp підтримує імпорт товарів із CSV або XLSX.</p>
			</article>
		</div>
		<div class="landing-inline-note">
	...
	<section class="landing-section landing-growth" id="growth">
		...
		<div class="landing-growth-grid">
			<article class="landing-growth-card">
				<strong>Клієнти та сегменти</strong>
				<p>Список покупців, активність, повторні покупки, LTV, картка замовлень і сегментація для роботи з базою.</p>
			</article>
			<article class="landing-growth-card">
				<strong>Кампанії</strong>
				<p>Розсилки по сегментах із бота та WebApp для нових, повторних або інших доступних аудиторій.</p>
			</article>
			<article class="landing-growth-card">
				<strong>Аналітика</strong>
				<p>Виторг, кількість замовлень, середній чек, конверсія, популярні товари й експорт звітів.</p>
			</article>
			<article class="landing-growth-card">
				<strong>Промокоди та cross-sell</strong>
				<p>Механіки для стимулювання повторних покупок і допродажів, коли магазин переходить з ручного режиму в системний.</p>
			</article>
		</div>
		<div class="landing-plan-note">
			<p>
				Частина цих можливостей підключається за планом. Це важливо: лендинг продає реальний продукт,
				а не обіцяє кожному магазину весь стек без урахування тарифу.
			</p>
		</div>
	</section>
	...
	<section class="landing-section landing-cta" id="launch">
		<div>
			...
			<p>
				...
				переходьте до self-hosted гайду.
			</p>
		</div>
